...
├─ 그룹패키지 │ └─ 프로젝트명패키지 │ ├─ controller │ │ └─ userController │ │ ├─ dto │ │ │ ├─ UserResponse (리턴값 DTO) │ │ │ ├─ UserRequest (RequestBody에 사용할 DTO) │ │ │ └─ UserVO (프로젝션) │ ├─ dao │ │ └─ model │ │ └─ User.java │ │ └─ repository │ │ └─ UserRepository │ ├─ exception │ │ └─ CustomException.java │ ├─ util │ │ └─ UtilityClass.java │ ├─ config │ │ └─ ModelMapperConfig.java │ ├─ domain │ │ ├─ User.java │ │ ├─ Token.java │ │ ├─ Stream.java │ │ ├─ Video.java │ │ ├─ Follower.java │ │ └─ Block.java └── build.gradle
